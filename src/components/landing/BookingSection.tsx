              ...
              <motion.div key="s1" variants={stepVariants} initial="enter" animate="center" exit="exit">
                ...
                <div className="grid grid-cols-2 gap-3 mb-6">
                  {Object.entries(PLANS).map(([key,p]) => (
                    <SelectionCard key={key} selected={selectedPlan===key} onClick={()=>{ setSelectedPlan(key); setSelectedDate(null); setSelectedPeriod(null); setInstallmentCount(1); setFinalAmount(null); setDiscountAmount(0); setVoucherChecked(false); }}>
